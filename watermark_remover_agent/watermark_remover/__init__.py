...
# succeed only if `torch` and related dependencies are installed.  In
# this lightweight version we simply expose None for all model
# functions when they cannot be imported.
try:
