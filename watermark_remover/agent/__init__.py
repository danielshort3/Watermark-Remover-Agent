...
# Expose the Ollama agent constructor at the package level.  This makes
# ``watermark_remover.agent.get_ollama_agent`` available for users who
# want to create an LLM-backed agent programmatically.
from .ollama_agent import get_ollama_agent  # noqa: F401